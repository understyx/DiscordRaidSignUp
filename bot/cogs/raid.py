    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await howto_thread.send(
                ...
                "**Signing up as tentative (Method 2)**\n"
                ...
                "**Marking priority specs (⭐)**\n"
                "Put ⭐ after the spec name to mark that specific spec as priority:\n"
                "`Lifedenier / Priest / Shadow ⭐ / 6500 / Disc / 6300` → Shadow is priority\n"
                "Put ⭐ at the very end of the line (after the last GS) to mark **all** specs as priority:\n"
                "`Puredecay / Hunter / Survival / 6500 ⭐` → all listed specs are priority\n\n"
