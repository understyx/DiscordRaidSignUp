...
function SetDisplay(number) {
    switch (number) {
        ...
        case "22": // Restoration
            ...
            break;
        case "23": // Affliction 
            SetupDisplay(["range", "players", "conqueror", "cloth", "raid_buff_12", "raid_buff_16", "offensive_dispel_01", "offensive_debuff_04", "offensive_debuff_06", "reduction_debuff_04"])
            break;
        case "24": // Demonology
            SetupDisplay(["range", "players", "conqueror", "cloth", "raid_buff_13", "offensive_debuff_04", "offensive_debuff_06", "reduction_debuff_04"])
            break;
        case "25": // Destruction 
            SetupDisplay(["range", "players", "conqueror", "cloth", "raid_buff_17", "offensive_debuff_06", "reduction_debuff_04", "resource_return_02"])
            break;
        case "26": // Arms
